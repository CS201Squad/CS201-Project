...
<body>
	...
	<div class="fb-header">
		<ul id="home" onclick="location.href='Search';" style="cursor: pointer;">
		...
		<form>
			...
			<!-- <button class="fb-header" id="search-btn">Courses</button>
			<button class="fb-header" id="search-btn">Professors</button> -->
			<input class="fb-header" id="search-btn" class=button type="submit" name="courses" value="Courses"/>
			<input class="fb-header" id="search-btn2" class=button type="submit" name="professors" value="Professors"/>
    ...
    <div style="margin-left: 1000px; margin-top: 140px;">
        <!-- <div class="col-md-12"> -->
            <button type="button" class="btn btn-primary" style="background-color: #990000; border-color: #990000">Add Review</button>
			<button type="button" class="btn btn-primary" style="background-color: #FFFFFF; border-color: #FFFFFF; color: #990000"> << Back</button>

			<!-- </div> -->
    </div>
	<div style="margin: 130px 0 auto auto;">
        <div class="title">Reviews</div>
        <!-- review per section! -->
        <%for(int i=0;i<reviews.size();i++){
        	Review r=reviews.get(i);%>
        <section class="write-review py-3 bg-light" id="write-review">
